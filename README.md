...
| --- | --- | --- |
| [`mubit-memory`](integrations/claude-code/) | 0.9.2 | Persistent, typed, self-improving memory for Claude Code — involuntary capture, pre-prompt recall, and outcome attribution. |
