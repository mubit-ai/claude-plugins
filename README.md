...
| --- | --- | --- |
| [`mubit-memory`](integrations/claude-code/) | 0.8.0 | Persistent, typed, self-improving memory for Claude Code — involuntary capture, pre-prompt recall, and outcome attribution. |
