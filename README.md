...
| --- | --- | --- |
| [`mubit-memory`](integrations/claude-code/) | 0.12.1 | Persistent, typed, self-improving memory for Claude Code — involuntary capture, pre-prompt recall, and outcome attribution. |
