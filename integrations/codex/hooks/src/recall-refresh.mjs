...
// @ts-check
/**
 * `hooks/src/recall-refresh.mjs` — the Codex entry point for the detached `recall-refresh` pass.
 *
 * It is absent from `hooks.json` on purpose — `prompt-recall.mjs` spawn it directly, detached —
...
await import('../../../claude-code/hooks/src/recall-refresh.mjs');
